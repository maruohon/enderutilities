...
import fi.dy.masa.enderutilities.client.renderer.entity.layers.LayerEnderFighterEyes;
...
public class RenderEndermanFighter extends RenderLiving
{
    ...
    public void doRender(EntityEndermanFighter entityEnderFighter, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        super.doRender((EntityLiving)entityEnderFighter, x, y, z, entityYaw, partialTicks);
    }
