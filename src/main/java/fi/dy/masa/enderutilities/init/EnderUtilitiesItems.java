...
{
	public static final Item enderArrow = new ItemEnderArrow();
	public static final Item enderBag = new ItemEnderBag();
	public static final Item enderBow = new ItemEnderBow();
	public static final Item enderBucket = new ItemEnderBucket();
	public static final Item enderLasso = new ItemEnderLasso();
	public static final Item enderPearlReusable = new ItemEnderPearlReusable();
