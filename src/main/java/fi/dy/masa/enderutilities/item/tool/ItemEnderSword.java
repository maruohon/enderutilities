...
public class ItemEnderSword extends ItemSword implements IKeyBound, IModular
{
    ...
    private void summonFighterEndermen(World world, EntityLivingBase targetEntity, int amount)
    {
        ...
        for (int i = 0; i < 64; ++i)
        {
            ...
            if (world.getCollidingBoundingBoxes(fighter, fighter.getEntityBoundingBox()).isEmpty()  == true && world.isAnyLiquid(fighter.getEntityBoundingBox()) == false
    ...
    public IFlexibleBakedModel getItemModel(ItemStack stack)
    {
        ...
        int i = getSwordMode(stack) + 1; // Head icons start at index 1
