...
import fi.dy.masa.enderutilities.client.renderer.model.block.ModelElevatorBaked;
...
public class ClientProxy extends CommonProxy
{
    ...
    private void registerBlockModels()
    {
        ...
        ModelLoaderRegistry.registerLoader(new ModelElevatorBaked.ModelLoaderElevator());
